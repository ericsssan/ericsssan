...
- **[KeyForCare Analytics](https://www.keyforcare.se)** — I automated the report generation and distribution pipeline with caching and pre-computation. *Vanilla PHP, Laravel, MySQL, Redis.*
